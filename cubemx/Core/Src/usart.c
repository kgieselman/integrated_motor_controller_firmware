...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC11     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = UART4_MCU_TO_CRSF_Pin|UART4_CRSF_TO_MCU_Pin;
  ...
  */
    ...
    PB15     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = USART1_MCU_TO_GROWTH_Pin|USART1_GROWTH_TO_MCU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART4_MCU_TO_CRSF_Pin|UART4_CRSF_TO_MCU_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB15     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, USART1_MCU_TO_GROWTH_Pin|USART1_GROWTH_TO_MCU_Pin);
